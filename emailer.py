...
universities = [
 {"name": "University of Edinburgh", "email": "futurestudents@ed.ac.uk"},
    ...
    {"name": "Ghent University", "email": "admission@ugent.be"},
    {"name": "University of Vienna", "email": "international@univie.ac.at"},
    {"name": "Heidelberg University", "email": "zulassung@uni-heidelberg.de"},
    {"name": "Humboldt University of Berlin", "email": "admission@uv.hu-berlin.de"},
    {"name": "Ludwig Maximilian University of Munich", "email": "studium@lmu.de"},
    {"name": "Technical University of Munich", "email": "studium@tum.de"},
    {"name": "University of Freiburg", "email": "admissions@service.uni-freiburg.de"},
    {"name": "University of Warsaw", "email": "study@uw.edu.pl"},
    {"name": "Jagiellonian University", "email": "admission@uj.edu.pl"},
    {"name": "Charles University", "email": "admissions@ruk.cuni.cz"},
    {"name": "University of Oslo", "email": "admissions@admin.uio.no"},
    {"name": "Norwegian University of Science and Technology (NTNU)", "email": "admission@adm.ntnu.no"},
    {"name": "University of Iceland", "email": "admissions@hi.is"},
    {"name": "University of Helsinki", "email": "admissions@helsinki.fi"},
    {"name": "Aalto University", "email": "admissions@aalto.fi"},
    {"name": "University of Barcelona", "email": "info.admission@ub.edu"},
    {"name": "Autonomous University of Madrid", "email": "informacion@adm.universidad.edu"},
    {"name": "University of Lisbon", "email": "info@ulisboa.pt"},
    {"name": "University of Porto", "email": "candidaturas@reit.up.pt"}
] 
]
# Email template
email_template = """
...
I hope this email finds you well. My name is Jillian Dalley, and I am writing to inquire about the admissions process, available scholarships, and any prerequisites or exceptions for international students interested in studying at {school_name}.
